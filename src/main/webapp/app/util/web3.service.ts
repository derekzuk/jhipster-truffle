...
let contractABI = require('./erc20abi.json');
...
export class Web3Service {
  ...
  private refreshAccounts() {
    ...
    public getERC20Balance(ethaccount){
        let MyContract = new this.web3.eth.Contract(this.ERC20TokenABI, '0xc63e7b1dece63a77ed7e4aeef5efb3b05c81438d');
        let decimal = MyContract.methods.decimals();
